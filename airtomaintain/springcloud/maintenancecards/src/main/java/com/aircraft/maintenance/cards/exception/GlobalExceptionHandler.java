...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(WorkCardAlreadyExistsException.class)
	public ResponseEntity<ErrorResponseDto> handlePartsAlreadyExistsException(WorkCardAlreadyExistsException workCardAlreadyExistsException, 
			WebRequest webRequest) {
		
		ErrorResponseDto errorResponseDto = new ErrorResponseDto(
				webRequest.getDescription(false),
				HttpStatus.BAD_REQUEST,
				workCardAlreadyExistsException.getMessage(),
				LocalDateTime.now()
				);
